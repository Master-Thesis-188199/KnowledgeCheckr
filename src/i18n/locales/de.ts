...
export default {
  ...
  Checks: {
    ...
    buttons: {
      create_question: 'Frage hinzufügen'
    },
    no_existing_questions: 'Derzeit sind diesem KnowledgeCheck keine Fragen zugeordnet',
    QuestionCard: {
      question_label: 'Frage',
      'points_label#one': '1 punkt',
      'points_label#other': '{count} punkte',
      points_label: '{count} punkte'
    }
  },
  Examination: {
