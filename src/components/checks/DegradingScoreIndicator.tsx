 ...
 */
export default function DegradingScoreIndicator({ knowledgeCheckScore }: { knowledgeCheckScore: number | undefined }) {
  ...
  return (
    <Tooltip content='Estimated knowledge retainment'>
      <div
        className={cn(
          'relative text-sm select-none dark:text-neutral-500/80',
        ...
        <CircleIcon className={cn('size-10 stroke-[1.5px]', knowledgeCheckScore === undefined && 'stroke-1')} />
