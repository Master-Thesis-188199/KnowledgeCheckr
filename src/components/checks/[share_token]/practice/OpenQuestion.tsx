  ...
  return (
    <textarea
      ...
      className={cn(
        ...
        'enabled:focus:ring-ring-focus enabled:dark:focus:ring-ring-focus enabled:hover:cursor-text enabled:hover:ring-neutral-500 enabled:focus:ring-[1.2px] enabled:dark:hover:ring-neutral-300/60',
        'resize-none',
        'my-auto h-full',
