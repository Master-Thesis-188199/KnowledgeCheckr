  ...
  return (
    <>
      ...
      <Element
        ...
        {...props}
        className={twMerge(
          'focus:ring-ring-focus dark:focus:ring-ring-focus rounded-md px-3 py-1.5 text-neutral-600 ring-1 ring-neutral-400 outline-none placeholder:text-neutral-400/90 hover:cursor-text hover:ring-neutral-500 focus:ring-[1.2px] dark:text-neutral-300/80 dark:ring-neutral-500 dark:placeholder:text-neutral-400/50 dark:hover:ring-neutral-300/60',
          props.className,
        )}
      />
    </>
