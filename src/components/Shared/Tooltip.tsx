  ...
  return (
    <HerouiTooltip
      ...
      className={cn(
        ...
        showsWarning && 'text-inherit shadow-orange-500/20 dark:text-orange-400 dark:shadow-orange-400/40',
        showsError && 'text-inherit shadow-red-500/30 dark:text-red-400/90 dark:shadow-red-400/40',
      )}></HerouiTooltip>
  )
}
