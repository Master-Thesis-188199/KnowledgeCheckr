  ...
  return (
    <svg width='24' height='24' className={className} viewBox='0 0 24 24' fill='currentColor' xmlns='http://www.w3.org/2000/svg' {...props}>
      ...
      <path
        ...
        fill='currentColor'
      />
      <path fillRule='evenodd' clipRule='evenodd' d='M12 6C12 5.44772 12.4477 5 13 5H21C21.5523 5 22 5.44772 22 6C22 6.55228 21.5523 7 21 7H13C12.4477 7 12 6.55228 12 6Z' fill='currentColor' />
      <path
        fillRule='evenodd'
        clipRule='evenodd'
