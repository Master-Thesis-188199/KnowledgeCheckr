  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button disabled={form.formState.disabled} aria-label={t('button_aria_label')} variant='input' role='combobox' aria-expanded={open} className='w-auto justify-between text-muted-foreground'>
