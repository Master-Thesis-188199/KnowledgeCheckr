...
import DisplayChoiceQuestionAnswer from '@/src/components/courses/[share_token]/(shared)/(questions)/ChoiceQuestionAnswer'
import { OpenQuestionAnswer } from '@/src/components/courses/[share_token]/(shared)/(questions)/OpenQuestionAnswer'
