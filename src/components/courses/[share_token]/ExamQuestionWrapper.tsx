...
import ExamFinishDialog from '@/src/components/courses/[share_token]/ExamFinishDialog'
import { useExaminationStore } from '@/src/components/courses/[share_token]/ExaminationStoreProvider'
import RenderExamQuestion from '@/src/components/courses/[share_token]/RenderExamQuestion'
...
export function ExamQuestionWrapper() {
  ...
  const { currentQuestionIndex, course, nextQuestion, previousQuestion, isLastQuestion, startExamination } = useExaminationStore((store) => store)
