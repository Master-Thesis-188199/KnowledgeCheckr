...
export function HeadingShortcutBadge({ level, shortcutKeys = HEADING_SHORTCUT_KEYS[level] }: { level: Level; shortcutKeys?: string }) {
...
export const HeadingButton = forwardRef<HTMLButtonElement, HeadingButtonProps>(
  ({ editor: providedEditor, level, text, hideWhenUnavailable = false, onToggled, showShortcut = false, onClick, children, ...buttonProps }, ref) => {
