...
// --- Lib ---
import { findNodePosition, getSelectedBlockNodes, isNodeInSchema, isNodeTypeSelected, isValidPosition, selectionWithinConvertibleTypes } from '@/lib/tiptap-utils'
...
export function toggleCodeBlock(editor: Editor | null): boolean {
  ...
  try {
    ...
    const isPossibleToTurnInto = selectionWithinConvertibleTypes(editor, ['paragraph', 'heading', 'bulletList', 'orderedList', 'taskList', 'blockquote', 'codeBlock']) && blocks.length === 1
