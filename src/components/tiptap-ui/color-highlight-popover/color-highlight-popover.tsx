...
export const ColorHighlightPopoverButton = forwardRef<HTMLButtonElement, ButtonProps>(({ className, children, ...props }, ref) => (
  <Button type='button' className={className} variant='ghost' data-appearance='default' role='button' tabIndex={-1} aria-label='Highlight text' tooltip='Highlight' ref={ref} {...props}>
