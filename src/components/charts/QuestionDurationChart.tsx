                    ...
                    return (
                      <div className='mt-2 flex flex-col gap-1'>
                        ...
                        <div className='text-foreground mt-1.5 flex items-center border-t pt-1.5 text-xs font-medium'>
                          ...
                          {item.payload.difference > 0 ? <span className='text-green-400'>Faster by</span> : <span className='text-red-400'>Slower by</span>}
                          <div className='text-foreground ml-auto flex items-baseline gap-0.5 font-mono font-medium tabular-nums'>
                            <span className={cn(item.payload.difference > 0 ? 'text-green-400' : 'text-red-400')}>{Math.abs(item.payload.difference)}</span>
                            <span className={cn('font-normal', item.payload.difference > 0 ? 'text-[oklch(79.2%_0.07_151.711)]' : 'text-[oklch(70.4%_0.07_22.216)]')}>minutes</span>
                          </div>
                        </div>
                      </div>
                    )
