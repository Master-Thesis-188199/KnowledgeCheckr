...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      role='group'
      className={cn(
        'group/input-group border-ring-subtle bg-input relative flex w-full items-center rounded-md border shadow-xs transition-[color,box-shadow] outline-none',
        ...
        // Focus state.
        'has-[[data-slot=input-group-control]:focus-visible]:!border-ring-hover has-[[data-slot=input-group-control]:focus-visible]:ring-ring-hover/50 has-[[data-slot=input-group-control]:focus-visible]:ring-[3px]',
