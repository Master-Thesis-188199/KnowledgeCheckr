...
export const ImageUploadNode: React.FC<NodeViewProps> = (props) => {
  ...
  return (
    <NodeViewWrapper className='tiptap-image-upload' tabIndex={0} onClick={handleClick}>
      ...
      <input ref={inputRef} name='file' accept={accept} type='file' multiple={limit > 1} onChange={handleChange} onClick={(e: React.MouseEvent<HTMLInputElement>) => e.stopPropagation()} />
    </NodeViewWrapper>
  )
}
