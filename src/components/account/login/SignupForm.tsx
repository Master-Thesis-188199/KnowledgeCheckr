    ...
    <form
      ...
      <div className='mt-2 flex flex-col items-center justify-center gap-3'>
        <button
          ...
          disabled={!isValid}
          className='hover:ring-ring-hover dark:hover:ring-ring-hover mt-2 w-full max-w-xs self-center rounded-lg bg-neutral-300 px-4 py-2 ring-1 ring-neutral-400 outline-0 hover:cursor-pointer hover:bg-neutral-400/40 hover:ring-[1.8px] active:bg-neutral-700/90 active:ring-neutral-600 dark:bg-neutral-700/40 dark:ring-neutral-700 dark:hover:bg-neutral-700/70'>
          Create account
        </button>
