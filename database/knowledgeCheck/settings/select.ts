...
import { instantiateKnowledgeCheckSettings, validateKnowledgeCheckSettings } from '@/src/schemas/KnowledgeCheckSettingsSchema'
...
export default async function getKnowledgeCheckSettingsById(id: KnowledgeCheck['id']) {
  ...
  return validateKnowledgeCheckSettings(settings?.at(0) ?? instantiateKnowledgeCheckSettings())
}
