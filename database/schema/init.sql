...
CREATE TABLE IF NOT EXISTS `KnowledgeCheckr-DB`.`User_has_done_KnowledgeCheck` (
  ...
  PRIMARY KEY (`id`, `user_id`, `knowledgeCheck_id`),
...
START TRANSACTION;
USE `KnowledgeCheckr-DB`;
INSERT INTO `KnowledgeCheckr-DB`.`Category` (`id`, `name`, `createdAt`, `updatedAt`, `prequisite_category_id`) VALUES ('628b11df-c906-421c-af25-f48e743adf2b', 'general', DEFAULT, DEFAULT, NULL);
